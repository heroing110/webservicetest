...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements example.HelloWorldService {
    ...
    public example.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            example.HelloWorldSoapBindingStub _stub = new example.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (example.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                example.HelloWorldSoapBindingStub _stub = new example.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
